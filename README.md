...
To play around with your scripts locally without affecting the real MyTurn
site, you can run a proxy server:

```bash
yarn dev
```

Access it at [http://localhost:3000](http://localhost:3000). All scripts that
you edit will be bundled into the site (including source maps), so you can
experiment with them. You can login as normal to access the admin area.
